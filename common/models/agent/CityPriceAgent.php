...
/**
 * This is the model class for table "{{%city_price_agent}}".
 *
 ...
 */
class CityPriceAgent extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['cate_id', 'province_id', 'city_id', 'area_id', 'day_time_init', 'day_range_init', 'night_time_init', 'night_range_init', 'status', 'approval_id', 'is_update', 'city_price_id', 'type', 'create_time', 'start_time', 'update_time', 'create_user_id', 'update_user_id'], 'integer'],
