...
return [
	'components' => [
		'db' => [
			...
			'dsn'         => 'mysql:host=rm-testing.mysql.rds.aliyuncs.com:3333;dbname=51bangbang',
			'username'    => 'bangbang',
			'password'    => 'BBangang5188#@!^#0',
			'charset'     => 'utf8',
		...
		'amap'           => [
			...
			'tableid' => '59b25d98afdf521e869ec474',
		],
		'alipay'         => [
			...
			'notify_url'         => 'https://pay.dev.281.com.cn/alipay/notify'
		],
		//		正式环境
		'GTPush'         => [    //旧版推送
