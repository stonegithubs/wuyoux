...
<div id="downTouch">
    ...
    <img src="/static/lottery/img/raw/img_banner_get.png" width="100%" style="pointer-events:none;"/>
        <div class="receivedBox">
            <span class="toptip">您已领取过大礼包啦！</span>
            <div><span class="leftFont">518大礼包已放入账户</span><span class="rightFont"><?= $mobile ?></span></div>
        </div>
        <div class="lineText">
            <div></div>
        ...
        <div class="libaoContent">
            <!-- <div><span class="num quan1"><i>￥</i>15</span><span class="quan">快送券</span></div>
			<div><span class="num quan2"><i>￥</i></span><span class="quan">通用券</span></div>
			<div><span class="num quan3"><i>￥</i>15</span><span class="quan font12">新用户券</span></div>
			<div><span class="num"></span><span></span></div> -->
        </div>
  ...
  $(document).ready(function(){
    ...
    for (var i = 0; i < dataLength.length; i++){
      if(dataLength[i].card_name=="通用券"){
        ...
        $(".libaoContent").append('<div><span class="num quan1"><i>￥</i>'+dataLength[i].card_price+'</span><span class="quan">'+dataLength[i].card_name+'</span></div>')
      }
      if(dataLength[i].card_name=="快送券"){
        $(".libaoContent").append('<div><span class="num quan3"><i>￥</i>'+dataLength[i].card_price+'</span><span class="quan">'+dataLength[i].card_name+'</span></div>')
      }
