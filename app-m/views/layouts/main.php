...
<head>
	...
	<?php
	if ($this->context->id == 'school' || $this->context->id == 'wallet' || $this->context->id == 'message') {
		echo '<link rel="stylesheet" href="/static/css/framework7.ios.min.css">
...
<?php
if ($this->context->id == 'school' || $this->context->id == 'message') {
	echo '<script type="text/javascript" src="/static/js/framework7.min.js"></script>
