...
<div class="main_box">
    ...
    <div class="regin_box">
        <div class="tip_box">
            ...
            <div class="text_box" id="user-tip">
...
<script type="text/javascript">
    ...
    function ajax_register() {
        ...
        var ajax_register ="/market-share/ajax-user-register";
        ...
        $.ajax({
            ...
            data: {
                ...
                longitude:longitude,
                latitude:latitude,
                invite_mobile:data.invite_mobile
            },
            dataType: 'json',
            success: function (res) {
                showToast(res.message);
                if(res.code===0) {
                sessionStorage.setItem("market_code", res.data.data.market_code);
                sessionStorage.setItem("entrance", data.entrance);
                window.location.href="<?= Url::to(['market-share/share?market_code=']); ?>"+res.data.data.market_code+"&entrance="+data.entrance;
                }
    ...
    function ajax_bang_register() {
        var checkbox = $(".checkbox").is(":checked");
        var ajax_register ="/market-share/ajax-provider-register";
        var code = $("#mes_code").val();
        var longitude = sessionStorage.getItem("longitude");
        var latitude = sessionStorage.getItem("latitude")
        var remobile = $("#registerMobile").val();
