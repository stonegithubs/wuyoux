...
class m180320_072523_create_wy_city_price_agent extends Migration
{
	public function safeUp()
	{
		$sql
			= "DROP TABLE IF EXISTS `wy_city_price_agent`;
CREATE TABLE `wy_city_price_agent` (
  ...
  `type` smallint(1) DEFAULT '0' COMMENT '类型 0常规 1回落',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='城市费率-常规调价表';";
	...
	{
		$this->dropTable('{{%city_price_agent}}');
	...
	{
		echo "m180320_072523_create_wy_city_price_agent cannot be reverted.\n";
