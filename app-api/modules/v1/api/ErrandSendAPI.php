...
class ErrandSendAPI extends HelperBase
{
	...
	{
		$user_location = AMapHelper::convert_baidu2Amap(SecurityHelper::getBodyParam("user_location"));    //参数
	...
	public static function addFeeV10($user_id)
	{
		...
		if ($orderRes) {
			...
			if ($payment_id == Ref::PAYMENT_TYPE_WECHAT) {
				...
				$payParams['notify_url']     = UrlHelper::payNotify("wxpay/errand-send-add-custom-fee");
